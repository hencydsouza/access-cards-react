...
const SidePanel = () => {
    ...
    return (
        <div className="bg-[rgb(20,_114,_230)] min-w-max lg:min-w-[13.5rem] h-screen overflow-y-scroll flex flex-col justify-center sm:rounded-br-[1rem] lg:rounded-br-[3rem] sm:rounded-tr-[1rem] lg:rounded-tr-[3rem] no-scrollbar z-10 shadow-sm" id="dash-side-menu">
